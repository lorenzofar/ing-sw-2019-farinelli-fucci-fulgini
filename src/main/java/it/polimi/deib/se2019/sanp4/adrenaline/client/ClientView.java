...
/**
 * A class representing the view implemented by a client, extending the {@link RemoteObservable} abstract class to
 * notify listeners about a {@link ViewEvent} generated by the user.
 */
public class ClientView extends RemoteObservable<ViewEvent> implements RemoteView {
    ...
    /**
     * The queue of requests that are waiting to be handled
